...
Different parameters are available, and must be changed in the programm itself (work in progress, an operator interface will be done in the future, but you know ...)

# Setup
# Parameters
In the CncFingerboard.py programm, from line 17 you will find :
Params1 = {
    "name" : "guitare folk",
    "scale" : 633,
    "nutWidth" : 43,
...
Read carefully the instructions provided by the programm.
